...
export const CardSolicitud = ({Solicitante, createdAt, Motivo, Cedula, Telefono1, Telefono2, Direccion, Detalles, id}) => {
  ...
  return (
    ...
    <CrearDenuncia active={active} toggle={toggle}>
        <div className={ModalDenuncias}>
            <div className={TituloDenuncia}>DETALLES DE LA SOLICITUD: {id}</div>
    ...
    <div className={CardDenuncia}>
        ...
        <div className={DenunciaCDA} onClick={toggle} ><p>Ver Solicitud</p></div>
        </div>
        </>
  )
}
